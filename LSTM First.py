# -*- coding: utf-8 -*-
"""
Created on Mon Oct  8 20:16:56 2018
...
df_import = pd.read_csv(filepath, nrows=nrows)
...
train_data, test_data=train_test_split(df2['mid price'], test_size = test_size, random_state=42)
...
for di in range(0,num_examples,smoothing_window_size):
...
test_points_seq = np.arange(num_examples,nrows,50).tolist()
...
best_prediction_epoch = 20 # replace this with the epoch that you got the best results when running the plotting code
